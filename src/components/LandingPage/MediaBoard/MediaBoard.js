        ...
        medias: [
          {
            ...
            index: 0,
            url_link: "http://theceo.in/2016/04/career-anna-creates-job-oriented-education-ecosystem/" 
          },
          {
            ...
            description: "Video-driven online learning platform Career Anna has raised Rs 3 crore structured financing from a group of angel investors represented by Subinder Khurana. The company plans to use the funds raised to launch a series of pro degree online learning programs on Artificial Intelligence, Data Science, Machine Learning, Deep Learning, DevOps and other new-technology fields",
            index: 1,
            url_link: "https://tech.economictimes.indiatimes.com/news/startups/online-learning-platform-career-anna-raises-rs-3-cr-funding/63891348"
          },
          {
            ...
            index: 2,
            url_link: "https://yourstory.com/2018/04/video-based-learning-platform-career-anna-raises-funding-rs-3-cr/"
          },{
            ...
            index: 3,
            url_link: "https://bizztor.com/careeranna-raised-inr-3-crore/"
          },
          {
            ...
            index: 4,
            url_link: "http://bwdisrupt.businessworld.in/article/Learning-Platform-Career-Anna-Raises-Rs-3-Cr-from-a-Group-of-Angel-Investors/23-04-2018-147214/"
          },
        ],
        media: {
          image_url: "http://www.upstart.net.au/wp-content/uploads/2017/07/The-CEO-Magazine-1.jpg",
...
prevProperty = () => {    
  ...
  render() {
    ...
    const showMedia = this.state.showMedia;

    return (
      <div class="MediaBoard">
        <div className="row">
          <div className="col-md-3 col-12 mediatext">
            media<span>board</span>
          </div>
          <div className="col-md-12 col-12 medias_playlist_wrapper">
            <div className="medias_playlist" style={{
				'transform': `translateX(-${media.index*(100/medias.length)}%)`
			}}>
              {
                medias.map((media_item, i) => 
                  <Card key={i} medias={media_item} current_index={showMedia?media.index:media.index-1}/>)
              }
          </div>
          </div>
